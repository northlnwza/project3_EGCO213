...
public class HowtoPlay extends JFrame{
    ...
    public HowtoPlay(JFrame ownerFrame, MySoundEffect ownerBackgroundMusic, VolumeManagement vm) {
    ...
    public void AddComponent() {
        ...
        main_backgroundImg  = new MyImageIcon(MyConstants.FILE_HowtoPlayMenu);
	drawpane = new JLabel();
	drawpane.setIcon(main_backgroundImg);
        ...
        drawpane.add(backPanel, BorderLayout.SOUTH);
